...
export async function loadDocument (doc: any, baseuri?: string, loadingOptions?: LoadingOptions): Promise<Internal.SaladRecordSchema | Internal.SaladEnumSchema | Internal.Documentation | Array<Internal.SaladRecordSchema | Internal.SaladEnumSchema | Internal.Documentation>> {
  if (baseuri == null) {
  ...
  return await documentLoad(LoaderInstances.unionOfSaladRecordSchemaLoaderOrSaladEnumSchemaLoaderOrDocumentationLoaderOrarrayOfunionOfSaladRecordSchemaLoaderOrSaladEnumSchemaLoaderOrDocumentationLoader, doc, baseuri, loadingOptions)
}

export async function loadDocumentByString (doc: string, uri: string, loadingOptions?: LoadingOptions): Promise<Internal.SaladRecordSchema | Internal.SaladEnumSchema | Internal.Documentation | Array<Internal.SaladRecordSchema | Internal.SaladEnumSchema | Internal.Documentation>> {
  ...
  return await documentLoad(LoaderInstances.unionOfSaladRecordSchemaLoaderOrSaladEnumSchemaLoaderOrDocumentationLoaderOrarrayOfunionOfSaladRecordSchemaLoaderOrSaladEnumSchemaLoaderOrDocumentationLoader, result, uri, loadingOptions)
}
